    ...
    <div className='w-full'>
      <div className='w-screen h-[50vh] relative'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='py-2'>Sneaker merce</h2>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-6 '>
        <div className='col-span-4'>
          ...
          This project is a web application built with React, Next.js, and  Javascript featuring a responsive UI styled using Tailwind CSS. The application is optimized for mobile and desktop experiences and is statically deployed on Vercel for reliable, high-performance delivery.
          </p>
          <Link
            href='https://sneakers-merce.vercel.app/'
            target='_blank'
          ...
          <Link
            href='https://github.com/Weten-Ogen/sneakers-ecommerce.git'
            target='_blank'
            referrerPolicy='no-referrer'
          >
